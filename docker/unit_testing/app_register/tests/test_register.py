...
def test_username():
    ...
    assert register.register('','toto@gmail.com','1234@aze') is False
    # Testing the space case
    assert register.register('rr rr','toto@gmail.com','1234@aze') is False

def test_email():   
    """Test function for the email
    """
    # Testing the email without @
    assert register.register('username','totogmail.com','1234@aze') is False
    # Testing the email without .
    assert register.register('username','toto@gmailcom','1234@aze') is False

def test_password():
    """Test function for the password
    """
    # Testing the case with less than 8 characters
    assert register.register('username','toto@gmail.com','1234@az') is False
    # TEsting the case with missing digits
    assert register.register('username','toto@gmail.com','abcd@azd') is False
    # Testing the case with missing characters
    assert register.register('username','toto@gmail.com','1234@123') is False
    # TEsting the case with missing special character
    assert register.register('username','toto@gmail.com','12341123') is True
